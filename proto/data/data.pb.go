...
type PressButtonResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PressButtonResponse) Reset() {
	*x = PressButtonResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *PressButtonResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PressButtonResponse) ProtoMessage() {}

func (x *PressButtonResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_data_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PressButtonResponse.ProtoReflect.Descriptor instead.
func (*PressButtonResponse) Descriptor() ([]byte, []int) {
	return file_proto_data_proto_rawDescGZIP(), []int{2}
}

func (x *PressButtonResponse) GetBody() string {
	if x != nil {
		return x.Body
	}
	return ""
...
var file_proto_data_proto_rawDesc = []byte{
	...
	,
...
var file_proto_data_proto_goTypes = []interface{}{
	...
	(*PressButtonResponse)(nil), // 2: data.PressButtonResponse
}
var file_proto_data_proto_depIdxs = []int32{
	0, // 0: data.DataService.GetButtons:input_type -> data.Empty
	0, // 1: data.DataService.PressButton:input_type -> data.Empty
	1, // 2: data.DataService.GetButtons:output_type -> data.GetButtonsResponse
	2, // 3: data.DataService.PressButton:output_type -> data.PressButtonResponse
...
func file_proto_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_data_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PressButtonResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
