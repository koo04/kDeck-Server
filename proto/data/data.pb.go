...
func (x *PressButtonRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_data_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PressButtonRequest.ProtoReflect.Descriptor instead.
func (*PressButtonRequest) Descriptor() ([]byte, []int) {
	return file_proto_data_proto_rawDescGZIP(), []int{2}
}

func (x *PressButtonRequest) GetPlugin() string {
	if x != nil {
		return x.Plugin
	}
	return ""
...
func (x *PressButtonRequest) GetAction() string {
	if x != nil {
		return x.Action
	}
	return ""
...
var file_proto_data_proto_rawDesc = []byte{
	...
	,
...
var file_proto_data_proto_goTypes = []interface{}{
	...
	(*PressButtonRequest)(nil), // 2: data.PressButtonRequest
}
var file_proto_data_proto_depIdxs = []int32{
	0, // 0: data.DataService.GetButtons:input_type -> data.Empty
	2, // 1: data.DataService.PressButton:input_type -> data.PressButtonRequest
	1, // 2: data.DataService.GetButtons:output_type -> data.GetButtonsResponse
	0, // 3: data.DataService.PressButton:output_type -> data.Empty
...
func file_proto_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_data_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PressButtonRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
